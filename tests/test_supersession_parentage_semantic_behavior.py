#!/usr/bin/env python3
"""Semantic-differentiation RTG supersession parentage semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "supersession-parentage-semantic-behavior.valid.json"

VALID_STATES = ['supersede', 'fork', 'stale', 'authority_conflict']
STATE_BY_SIGNAL = {1: 'supersede', 2: 'fork', 3: 'stale', 4: 'authority_conflict'}
...
def main():
    ...
    print("RTG supersession parentage semantic behavior tests passed.")
