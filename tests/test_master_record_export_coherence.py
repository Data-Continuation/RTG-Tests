#!/usr/bin/env python3
"""Provisional RTG master record export coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "master-record-export-coherence.valid.json"

VALID_STATES = ['master_record_export_valid', 'authority_failure', 'lineage_failure', 'export_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "export_failure"
    return "master_record_export_valid"
...
def main() -> None:
    ...
    print("RTG master record export coherence tests passed.")
