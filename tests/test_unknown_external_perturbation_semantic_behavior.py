#!/usr/bin/env python3
"""Semantic-differentiation RTG unknown external perturbation semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "unknown-external-perturbation-semantic-behavior.valid.json"

VALID_STATES = ['modeled', 'external_perturbation', 'late_explanation_pending', 'preserve_anomaly']
STATE_BY_SIGNAL = {1: 'modeled', 2: 'external_perturbation', 3: 'late_explanation_pending', 4: 'preserve_anomaly'}
...
def main():
    ...
    print("RTG unknown external perturbation semantic behavior tests passed.")
