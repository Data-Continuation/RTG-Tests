#!/usr/bin/env python3
"""Provisional RTG consensus receipt hash repair coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "consensus-receipt-hash-repair-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG consensus receipt hash repair coherence tests passed.")
