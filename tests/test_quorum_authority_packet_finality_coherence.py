#!/usr/bin/env python3
"""Provisional RTG quorum authority packet finality coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "quorum-authority-packet-finality-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG quorum authority packet finality coherence tests passed.")
