#!/usr/bin/env python3
"""Provisional RTG temporal lineage export coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "temporal-lineage-export-coherence.valid.json"

VALID_STATES = ['temporal_export_valid', 'authority_failure', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def main() -> None:
    ...
    print("RTG temporal lineage export coherence tests passed.")
