#!/usr/bin/env python3
"""Provisional RTG detector identity surface packet coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "detector-identity-surface-packet-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG detector identity surface packet coherence tests passed.")
