...
FIXTURE_PATH = ROOT / "fixtures" / "shadow-transition-quarantine-release-coherence.valid.json"
...
def main():
    ...
    print("RTG shadow transition quarantine release coherence tests passed.")
