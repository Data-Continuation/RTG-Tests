...
FIXTURE_PATH = ROOT / "fixtures" / "detector-coverage-threshold-semantic-behavior.valid.json"
VALID_STATES = {'compatible', 'identity_incompatible', 'upgrade_required', 'coverage_shortfall'}
...
def main():
    ...
    if payload.get("mechanism_group") != "detector":
    ...
    print("RTG detector coverage threshold semantic behavior tests passed.")
