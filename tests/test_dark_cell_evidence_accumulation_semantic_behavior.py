#!/usr/bin/env python3
"""Semantic-differentiation RTG dark cell evidence accumulation semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "dark-cell-evidence-accumulation-semantic-behavior.valid.json"

VALID_STATES = ['dark', 'dim', 'colored', 'saturated']
STATE_BY_SIGNAL = {1: 'dark', 2: 'dim', 3: 'colored', 4: 'saturated'}
EXPECTED_GROUP = "dark"
...
def main():
    ...
    print("RTG dark cell evidence accumulation semantic behavior tests passed.")
