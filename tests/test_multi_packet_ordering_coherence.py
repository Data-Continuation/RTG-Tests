#!/usr/bin/env python3
"""Provisional RTG multi packet ordering coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "multi-packet-ordering-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG multi packet ordering coherence tests passed.")
