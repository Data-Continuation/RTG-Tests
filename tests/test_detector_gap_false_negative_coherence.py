#!/usr/bin/env python3
"""Provisional RTG detector gap false negative coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "detector-gap-false-negative-coherence.valid.json"
...
def main():
    ...
    print("RTG detector gap false negative coherence tests passed.")
