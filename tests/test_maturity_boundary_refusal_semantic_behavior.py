#!/usr/bin/env python3
"""Semantic-differentiation RTG maturity boundary refusal semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "maturity-boundary-refusal-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG maturity boundary refusal semantic behavior tests passed.")
