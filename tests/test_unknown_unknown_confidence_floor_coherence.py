#!/usr/bin/env python3
"""Provisional RTG unknown unknown confidence floor coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "unknown-unknown-confidence-floor-coherence.valid.json"
...
def main():
    ...
    print("RTG unknown unknown confidence floor coherence tests passed.")
