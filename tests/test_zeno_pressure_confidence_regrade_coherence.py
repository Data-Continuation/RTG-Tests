#!/usr/bin/env python3
"""Provisional RTG zeno pressure confidence regrade coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "zeno-pressure-confidence-regrade-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG zeno pressure confidence regrade coherence tests passed.")
