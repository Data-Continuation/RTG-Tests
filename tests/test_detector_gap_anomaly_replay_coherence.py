#!/usr/bin/env python3
"""Provisional RTG detector gap anomaly replay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "detector-gap-anomaly-replay-coherence.valid.json"

VALID_STATES = ['detector_gap_anomaly_retained', 'detector_gap', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "replay_failure"
    return "detector_gap_anomaly_retained"
...
def main() -> None:
    ...
    print("RTG detector gap anomaly replay coherence tests passed.")
