#!/usr/bin/env python3
"""Provisional RTG cell shell coupling export coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "cell-shell-coupling-export-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG cell shell coupling export coherence tests passed.")
