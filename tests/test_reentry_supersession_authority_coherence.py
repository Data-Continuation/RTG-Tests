#!/usr/bin/env python3
"""Provisional RTG reentry supersession authority coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "reentry-supersession-authority-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG reentry supersession authority coherence tests passed.")
