#!/usr/bin/env python3
"""Provisional RTG admissibility observation geometry coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "admissibility-observation-geometry-coherence.valid.json"
...
def main():
    ...
    print("RTG admissibility observation geometry coherence tests passed.")
