#!/usr/bin/env python3
"""Provisional RTG observer identity packet replay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "observer-identity-packet-replay-coherence.valid.json"

VALID_STATES = ['observer_identity_packet_valid', 'observer_incompatible', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "replay_failure"
    return "observer_identity_packet_valid"
...
def main() -> None:
    ...
    print("RTG observer identity packet replay coherence tests passed.")
