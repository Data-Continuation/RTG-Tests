#!/usr/bin/env python3
"""Provisional RTG detector upgrade anomaly resolution coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "detector-upgrade-anomaly-resolution-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG detector upgrade anomaly resolution coherence tests passed.")
