#!/usr/bin/env python3
"""Provisional RTG state packet supersession export coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "state-packet-supersession-export-coherence.valid.json"

VALID_STATES = ['state_supersession_export_valid', 'authority_failure', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "replay_failure"
    return "state_supersession_export_valid"
...
def main() -> None:
    ...
    print("RTG state packet supersession export coherence tests passed.")
