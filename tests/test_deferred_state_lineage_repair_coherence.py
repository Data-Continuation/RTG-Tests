#!/usr/bin/env python3
"""Provisional RTG deferred state lineage repair coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "deferred-state-lineage-repair-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG deferred state lineage repair coherence tests passed.")
