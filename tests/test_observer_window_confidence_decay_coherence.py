#!/usr/bin/env python3
"""Provisional RTG observer window confidence decay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "observer-window-confidence-decay-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG observer window confidence decay coherence tests passed.")
