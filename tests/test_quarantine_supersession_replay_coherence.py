#!/usr/bin/env python3
"""Provisional RTG quarantine supersession replay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "quarantine-supersession-replay-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG quarantine supersession replay coherence tests passed.")
