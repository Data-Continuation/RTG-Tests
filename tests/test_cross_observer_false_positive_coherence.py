#!/usr/bin/env python3
"""Provisional RTG cross observer false positive coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "cross-observer-false-positive-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG cross observer false positive coherence tests passed.")
