#!/usr/bin/env python3
"""Provisional RTG master record reentry authority coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "master-record-reentry-authority-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG master record reentry authority coherence tests passed.")
