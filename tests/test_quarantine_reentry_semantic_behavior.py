#!/usr/bin/env python3
"""Semantic-differentiation RTG quarantine reentry semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "quarantine-reentry-semantic-behavior.valid.json"

VALID_STATES = ['release', 'hold_risk', 'hold_time', 'hold_authority', 'reentry_review']
STATE_BY_SIGNAL = {1: 'release', 2: 'hold_risk', 3: 'hold_time', 4: 'hold_authority', 5: 'reentry_review'}
...
def main():
    ...
    print("RTG quarantine reentry semantic behavior tests passed.")
