#!/usr/bin/env python3
"""Provisional RTG governance loop supersession coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "governance-loop-supersession-coherence.valid.json"

VALID_STATES = ['governance_loop_valid', 'authority_failure', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def main() -> None:
    ...
    print("RTG governance loop supersession coherence tests passed.")
