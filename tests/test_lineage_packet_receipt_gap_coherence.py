#!/usr/bin/env python3
"""Provisional RTG lineage packet receipt gap coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "lineage-packet-receipt-gap-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG lineage packet receipt gap coherence tests passed.")
