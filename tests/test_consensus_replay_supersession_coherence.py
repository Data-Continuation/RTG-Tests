#!/usr/bin/env python3
"""Provisional RTG consensus replay supersession coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "consensus-replay-supersession-coherence.valid.json"
...
def main():
    ...
    print("RTG consensus replay supersession coherence tests passed.")
