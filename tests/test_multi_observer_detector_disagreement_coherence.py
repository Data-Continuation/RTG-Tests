#!/usr/bin/env python3
"""Provisional RTG multi observer detector disagreement coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "multi-observer-detector-disagreement-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG multi observer detector disagreement coherence tests passed.")
