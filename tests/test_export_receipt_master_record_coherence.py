#!/usr/bin/env python3
"""Provisional RTG export receipt master record coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "export-receipt-master-record-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG export receipt master record coherence tests passed.")
