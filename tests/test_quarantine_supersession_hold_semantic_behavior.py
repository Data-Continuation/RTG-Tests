#!/usr/bin/env python3
"""Semantic-differentiation RTG quarantine supersession hold semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "quarantine-supersession-hold-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG quarantine supersession hold semantic behavior tests passed.")
