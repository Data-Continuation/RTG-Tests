#!/usr/bin/env python3
"""Provisional RTG identity detector authority coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "identity-detector-authority-coherence.valid.json"

VALID_STATES = ['identity_detected_authorized', 'detector_gap', 'identity_mismatch', 'authority_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "authority_failure"
    return "identity_detected_authorized"
...
def main() -> None:
    ...
    print("RTG identity detector authority coherence tests passed.")
