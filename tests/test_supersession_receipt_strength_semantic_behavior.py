#!/usr/bin/env python3
"""Semantic-differentiation RTG supersession receipt strength semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "supersession-receipt-strength-semantic-behavior.valid.json"

VALID_STATES = ['supersede', 'weak_receipt', 'temporal_disorder', 'authority_conflict']
STATE_BY_SIGNAL = {1: 'supersede', 2: 'weak_receipt', 3: 'temporal_disorder', 4: 'authority_conflict'}
EXPECTED_GROUP = "supersession"
...
def main():
    ...
    print("RTG supersession receipt strength semantic behavior tests passed.")
