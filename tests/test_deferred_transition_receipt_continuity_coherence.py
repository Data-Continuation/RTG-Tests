...
FIXTURE_PATH = ROOT / "fixtures" / "deferred-transition-receipt-continuity-coherence.valid.json"
...
def main():
    ...
    print("RTG deferred transition receipt continuity coherence tests passed.")
