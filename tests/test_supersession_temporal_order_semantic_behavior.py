#!/usr/bin/env python3
"""Semantic-differentiation RTG supersession temporal order semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "supersession-temporal-order-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG supersession temporal order semantic behavior tests passed.")
