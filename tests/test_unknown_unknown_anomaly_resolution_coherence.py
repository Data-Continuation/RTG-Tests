#!/usr/bin/env python3
"""Provisional RTG unknown unknown anomaly resolution coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "unknown-unknown-anomaly-resolution-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG unknown unknown anomaly resolution coherence tests passed.")
