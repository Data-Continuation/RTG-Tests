#!/usr/bin/env python3
"""Provisional RTG authority decay replay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "authority-decay-replay-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG authority decay replay coherence tests passed.")
