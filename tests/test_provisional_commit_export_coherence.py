#!/usr/bin/env python3
"""Provisional RTG provisional commit export coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "provisional-commit-export-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG provisional commit export coherence tests passed.")
