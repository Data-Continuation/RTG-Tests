#!/usr/bin/env python3
"""Provisional RTG quorum detector replay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "quorum-detector-replay-coherence.valid.json"

VALID_STATES = ['quorum_replay_valid', 'detector_gap', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def main() -> None:
    ...
    print("RTG quorum detector replay coherence tests passed.")
