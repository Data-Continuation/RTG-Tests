#!/usr/bin/env python3
"""Semantic-differentiation RTG governance output block semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "governance-output-block-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG governance output block semantic behavior tests passed.")
