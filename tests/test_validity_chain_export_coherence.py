#!/usr/bin/env python3
"""Provisional RTG validity chain export coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "validity-chain-export-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG validity chain export coherence tests passed.")
