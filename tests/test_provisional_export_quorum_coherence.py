#!/usr/bin/env python3
"""Provisional RTG provisional export quorum coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "provisional-export-quorum-coherence.valid.json"
...
def main():
    ...
    print("RTG provisional export quorum coherence tests passed.")
