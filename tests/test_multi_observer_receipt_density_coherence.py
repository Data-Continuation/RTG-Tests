#!/usr/bin/env python3
"""Provisional RTG multi observer receipt density coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "multi-observer-receipt-density-coherence.valid.json"
...
def main():
    ...
    print("RTG multi observer receipt density coherence tests passed.")
