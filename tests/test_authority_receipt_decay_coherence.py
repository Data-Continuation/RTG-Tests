#!/usr/bin/env python3
"""Provisional RTG authority receipt decay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "authority-receipt-decay-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG authority receipt decay coherence tests passed.")
