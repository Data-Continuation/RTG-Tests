#!/usr/bin/env python3
"""Provisional RTG source target detector disagreement coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "source-target-detector-disagreement-coherence.valid.json"
...
def main():
    ...
    print("RTG source target detector disagreement coherence tests passed.")
