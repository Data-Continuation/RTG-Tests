#!/usr/bin/env python3
"""Semantic-differentiation RTG export boundary master record semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "export-boundary-master-record-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG export boundary master record semantic behavior tests passed.")
