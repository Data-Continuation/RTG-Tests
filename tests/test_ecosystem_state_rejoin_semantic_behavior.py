#!/usr/bin/env python3
"""Semantic-differentiation RTG ecosystem state rejoin semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "ecosystem-state-rejoin-semantic-behavior.valid.json"

VALID_STATES = ['rejoin', 'stale_rejoin', 'review_required', 'blocked']
STATE_BY_SIGNAL = {1: 'rejoin', 2: 'stale_rejoin', 3: 'review_required', 4: 'blocked'}
EXPECTED_GROUP = "ecosystem"
...
def main():
    ...
    print("RTG ecosystem state rejoin semantic behavior tests passed.")
