#!/usr/bin/env python3
"""Provisional RTG receipt chain reversal coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "receipt-chain-reversal-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG receipt chain reversal coherence tests passed.")
