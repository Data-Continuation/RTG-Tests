#!/usr/bin/env python3
"""Provisional RTG deferred emission supersession coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "deferred-emission-supersession-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG deferred emission supersession coherence tests passed.")
