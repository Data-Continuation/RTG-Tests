#!/usr/bin/env python3
"""Semantic-differentiation RTG receipt chain gap semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "receipt-chain-gap-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG receipt chain gap semantic behavior tests passed.")
