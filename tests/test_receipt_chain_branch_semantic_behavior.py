#!/usr/bin/env python3
"""Semantic-differentiation RTG receipt chain branch semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "receipt-chain-branch-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG receipt chain branch semantic behavior tests passed.")
