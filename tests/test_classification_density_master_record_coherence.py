#!/usr/bin/env python3
"""Provisional RTG classification density master record coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "classification-density-master-record-coherence.valid.json"
...
def main():
    ...
    print("RTG classification density master record coherence tests passed.")
