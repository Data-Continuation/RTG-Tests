#!/usr/bin/env python3
"""Provisional RTG admissibility receipt drift coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "admissibility-receipt-drift-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG admissibility receipt drift coherence tests passed.")
