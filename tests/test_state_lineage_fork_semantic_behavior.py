#!/usr/bin/env python3
"""Semantic-differentiation RTG state lineage fork semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "state-lineage-fork-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG state lineage fork semantic behavior tests passed.")
