#!/usr/bin/env python3
"""Semantic-differentiation RTG zeno retry budget semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "zeno-retry-budget-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG zeno retry budget semantic behavior tests passed.")
