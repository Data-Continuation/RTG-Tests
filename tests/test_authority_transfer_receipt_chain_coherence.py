#!/usr/bin/env python3
"""Provisional RTG authority transfer receipt chain coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "authority-transfer-receipt-chain-coherence.valid.json"
...
def main():
    ...
    print("RTG authority transfer receipt chain coherence tests passed.")
