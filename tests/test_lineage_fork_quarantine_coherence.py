#!/usr/bin/env python3
"""Provisional RTG lineage fork quarantine coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "lineage-fork-quarantine-coherence.valid.json"

VALID_STATES = ['fork_quarantine_valid', 'authority_failure', 'fork_failure', 'replay_failure', 'risk_quarantine']
...
def main() -> None:
    ...
    print("RTG lineage fork quarantine coherence tests passed.")
