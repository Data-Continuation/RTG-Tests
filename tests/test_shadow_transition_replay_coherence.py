#!/usr/bin/env python3
"""Provisional RTG shadow transition replay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "shadow-transition-replay-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG shadow transition replay coherence tests passed.")
