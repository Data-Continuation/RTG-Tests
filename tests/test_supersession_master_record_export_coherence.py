#!/usr/bin/env python3
"""Provisional RTG supersession master record export coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "supersession-master-record-export-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG supersession master record export coherence tests passed.")
