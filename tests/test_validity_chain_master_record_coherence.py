#!/usr/bin/env python3
"""Provisional RTG validity chain master record coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "validity-chain-master-record-coherence.valid.json"
...
def main():
    ...
    print("RTG validity chain master record coherence tests passed.")
