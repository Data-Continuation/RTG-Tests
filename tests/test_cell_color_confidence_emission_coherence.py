#!/usr/bin/env python3
"""Provisional RTG cell color confidence emission coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "cell-color-confidence-emission-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG cell color confidence emission coherence tests passed.")
