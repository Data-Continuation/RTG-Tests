#!/usr/bin/env python3
"""Semantic-differentiation RTG detector upgrade semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "detector-upgrade-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG detector upgrade semantic behavior tests passed.")
