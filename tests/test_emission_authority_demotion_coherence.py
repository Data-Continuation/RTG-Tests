#!/usr/bin/env python3
"""Provisional RTG emission authority demotion coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "emission-authority-demotion-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG emission authority demotion coherence tests passed.")
