...
FIXTURE_PATH = ROOT / "fixtures" / "transition-claim-quarantine-boundary-coherence.valid.json"
...
def main():
    ...
    print("RTG transition claim quarantine boundary coherence tests passed.")
