#!/usr/bin/env python3
"""Provisional RTG authority demotion supersession coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "authority-demotion-supersession-coherence.valid.json"

VALID_STATES = ['authority_demotion_valid', 'authority_failure', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "replay_failure"
    return "authority_demotion_valid"
...
def main() -> None:
    ...
    print("RTG authority demotion supersession coherence tests passed.")
