#!/usr/bin/env python3
"""Provisional RTG dark cell master record export coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "dark-cell-master-record-export-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG dark cell master record export coherence tests passed.")
