#!/usr/bin/env python3
"""Provisional RTG receipt export authority coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "receipt-export-authority-coherence.valid.json"

VALID_STATES = ['receipt_export_authorized', 'authority_failure', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "replay_failure"
    return "receipt_export_authorized"
...
def main() -> None:
    ...
    print("RTG receipt export authority coherence tests passed.")
