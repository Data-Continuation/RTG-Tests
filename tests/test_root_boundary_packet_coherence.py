#!/usr/bin/env python3
"""Provisional RTG root boundary packet coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "root-boundary-packet-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG root boundary packet coherence tests passed.")
