#!/usr/bin/env python3
"""Provisional RTG quarantine decay review coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "quarantine-decay-review-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG quarantine decay review coherence tests passed.")
