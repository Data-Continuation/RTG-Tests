#!/usr/bin/env python3
"""Provisional RTG source identity receipt export coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "source-identity-receipt-export-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG source identity receipt export coherence tests passed.")
