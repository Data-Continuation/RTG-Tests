#!/usr/bin/env python3
"""Provisional RTG shadow transition detector upgrade coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "shadow-transition-detector-upgrade-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG shadow transition detector upgrade coherence tests passed.")
