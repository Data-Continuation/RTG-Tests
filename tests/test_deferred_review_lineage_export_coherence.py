#!/usr/bin/env python3
"""Provisional RTG deferred review lineage export coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "deferred-review-lineage-export-coherence.valid.json"
...
def main():
    ...
    print("RTG deferred review lineage export coherence tests passed.")
