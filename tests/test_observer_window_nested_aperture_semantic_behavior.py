...
FIXTURE_PATH = ROOT / "fixtures" / "observer-window-nested-aperture-semantic-behavior.valid.json"
VALID_STATES = {'dwell_short', 'observable', 'nested_aperture_block', 'sampling_alias'}
...
def main():
    ...
    if payload.get("mechanism_group") != "observer":
    ...
    print("RTG observer window nested aperture semantic behavior tests passed.")
