#!/usr/bin/env python3
"""Provisional RTG state evidence authority decay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "state-evidence-authority-decay-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG state evidence authority decay coherence tests passed.")
