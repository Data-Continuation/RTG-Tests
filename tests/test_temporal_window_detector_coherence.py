#!/usr/bin/env python3
"""Provisional RTG temporal window detector coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "temporal-window-detector-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG temporal window detector coherence tests passed.")
