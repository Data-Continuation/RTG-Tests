#!/usr/bin/env python3
"""Provisional RTG dark cell quarantine supersession coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "dark-cell-quarantine-supersession-coherence.valid.json"

VALID_STATES = ['dark_supersession_valid', 'authority_failure', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "replay_failure"
    return "dark_supersession_valid"
...
def main() -> None:
    ...
    print("RTG dark cell quarantine supersession coherence tests passed.")
