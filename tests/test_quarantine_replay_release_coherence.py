#!/usr/bin/env python3
"""Provisional RTG quarantine replay release coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "quarantine-replay-release-coherence.valid.json"

VALID_STATES = ['quarantine_replay_release_valid', 'authority_failure', 'lineage_failure', 'replay_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "replay_failure"
    return "quarantine_replay_release_valid"
...
def main() -> None:
    ...
    print("RTG quarantine replay release coherence tests passed.")
