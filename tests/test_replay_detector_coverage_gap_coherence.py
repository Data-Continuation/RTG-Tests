#!/usr/bin/env python3
"""Provisional RTG replay detector coverage gap coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "replay-detector-coverage-gap-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG replay detector coverage gap coherence tests passed.")
