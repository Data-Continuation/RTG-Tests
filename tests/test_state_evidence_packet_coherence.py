#!/usr/bin/env python3
"""Provisional RTG state evidence packet coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "state-evidence-packet-coherence.valid.json"

VALID_STATES = ['state_evidence_packet_valid', 'authority_failure', 'lineage_failure', 'evidence_failure', 'risk_quarantine']
...
def classify(case: dict[str, Any]) -> str:
    ...
    if not case["secondary_ok"]:
        return "evidence_failure"
    return "state_evidence_packet_valid"
...
def main() -> None:
    ...
    print("RTG state evidence packet coherence tests passed.")
