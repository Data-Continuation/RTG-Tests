#!/usr/bin/env python3
"""Semantic-differentiation RTG receipt repair window semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "receipt-repair-window-semantic-behavior.valid.json"

VALID_STATES = ['continuous', 'branch_detected', 'repair_window_open', 'repair_window_closed']
STATE_BY_SIGNAL = {1: 'continuous', 2: 'branch_detected', 3: 'repair_window_open', 4: 'repair_window_closed'}
EXPECTED_GROUP = "receipt"
...
def main():
    ...
    print("RTG receipt repair window semantic behavior tests passed.")
