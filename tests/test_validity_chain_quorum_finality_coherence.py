#!/usr/bin/env python3
"""Provisional RTG validity chain quorum finality coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "validity-chain-quorum-finality-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG validity chain quorum finality coherence tests passed.")
