#!/usr/bin/env python3
"""Provisional RTG consensus detector lineage coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "consensus-detector-lineage-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG consensus detector lineage coherence tests passed.")
