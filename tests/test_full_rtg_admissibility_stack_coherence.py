#!/usr/bin/env python3
"""Provisional RTG full rtg admissibility stack coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "full-rtg-admissibility-stack-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG full rtg admissibility stack coherence tests passed.")
