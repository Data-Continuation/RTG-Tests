#!/usr/bin/env python3
"""Semantic-differentiation RTG unknown late explanation semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "unknown-late-explanation-semantic-behavior.valid.json"
...
def main():
    ...
    print("RTG unknown late explanation semantic behavior tests passed.")
