#!/usr/bin/env python3
"""Semantic-differentiation RTG master record reconstruction semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "master-record-reconstruction-semantic-behavior.valid.json"

VALID_STATES = ['reconstructable', 'reconstruction_gap', 'receipt_gap', 'blocked']
STATE_BY_SIGNAL = {1: 'reconstructable', 2: 'reconstruction_gap', 3: 'receipt_gap', 4: 'blocked'}
EXPECTED_GROUP = "master"
...
def main():
    ...
    print("RTG master record reconstruction semantic behavior tests passed.")
