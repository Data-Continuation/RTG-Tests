...
FIXTURE_PATH = ROOT / "fixtures" / "confidence-detector-quality-semantic-behavior.valid.json"
VALID_STATES = {'source_drift_review', 'downgrade', 'maintain', 'detector_quality_defer', 'upgrade'}
...
def main():
    ...
    if payload.get("mechanism_group") != "confidence":
    ...
    print("RTG confidence detector quality semantic behavior tests passed.")
