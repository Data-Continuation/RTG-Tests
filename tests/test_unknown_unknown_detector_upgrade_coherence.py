#!/usr/bin/env python3
"""Provisional RTG unknown unknown detector upgrade coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "unknown-unknown-detector-upgrade-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG unknown unknown detector upgrade coherence tests passed.")
