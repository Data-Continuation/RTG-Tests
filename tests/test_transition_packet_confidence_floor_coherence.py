#!/usr/bin/env python3
"""Provisional RTG transition packet confidence floor coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "transition-packet-confidence-floor-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG transition packet confidence floor coherence tests passed.")
