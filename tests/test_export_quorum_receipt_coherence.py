#!/usr/bin/env python3
"""Provisional RTG export quorum receipt coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "export-quorum-receipt-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG export quorum receipt coherence tests passed.")
