#!/usr/bin/env python3
"""Semantic-differentiation RTG purpose convergence support failure semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "purpose-convergence-support-failure-semantic-behavior.valid.json"

VALID_STATES = ['purpose_aligned', 'recoverability_failure', 'support_failure', 'purpose_inverting']
STATE_BY_SIGNAL = {1: 'purpose_aligned', 2: 'recoverability_failure', 3: 'support_failure', 4: 'purpose_inverting'}
EXPECTED_GROUP = "purpose"
...
def main():
    ...
    print("RTG purpose convergence support failure semantic behavior tests passed.")
