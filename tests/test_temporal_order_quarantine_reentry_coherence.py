#!/usr/bin/env python3
"""Provisional RTG temporal order quarantine reentry coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "temporal-order-quarantine-reentry-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG temporal order quarantine reentry coherence tests passed.")
