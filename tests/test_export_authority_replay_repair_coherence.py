#!/usr/bin/env python3
"""Provisional RTG export authority replay repair coherence tests."""
from __future__ import annotations
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_PATH = ROOT / "fixtures" / "export-authority-replay-repair-coherence.valid.json"
...
def main():
    ...
    print("RTG export authority replay repair coherence tests passed.")
