#!/usr/bin/env python3
"""Semantic-differentiation RTG governance output quarantine binding semantic behavior tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "governance-output-quarantine-binding-semantic-behavior.valid.json"

VALID_STATES = ['consistent', 'receipt_unbound', 'quarantine_unbound', 'blocked']
STATE_BY_SIGNAL = {1: 'consistent', 2: 'receipt_unbound', 3: 'quarantine_unbound', 4: 'blocked'}
EXPECTED_GROUP = "governance"
...
def main():
    ...
    print("RTG governance output quarantine binding semantic behavior tests passed.")
