#!/usr/bin/env python3
"""Provisional RTG receipt gap replay repair coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "receipt-gap-replay-repair-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG receipt gap replay repair coherence tests passed.")
