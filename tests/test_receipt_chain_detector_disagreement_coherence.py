...
FIXTURE_PATH = ROOT / "fixtures" / "receipt-chain-detector-disagreement-coherence.valid.json"
...
def main():
    ...
    print("RTG receipt chain detector disagreement coherence tests passed.")
