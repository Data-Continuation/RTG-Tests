#!/usr/bin/env python3
"""Semantic-differentiation RTG detector disagreement semantic behavior hotfix test."""
...
FIXTURE_PATH = ROOT / "fixtures" / "detector-disagreement-semantic-behavior.valid.json"

VALID_STATES = ['compatible', 'upgrade_required', 'disagreement', 'blindspot']
STATE_BY_SIGNAL = {1: 'compatible', 2: 'upgrade_required', 3: 'disagreement', 4: 'blindspot'}
...
def main():
    ...
    print("RTG detector disagreement semantic behavior tests passed.")
