#!/usr/bin/env python3
"""Provisional RTG provisional state promotion coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "provisional-state-promotion-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG provisional state promotion coherence tests passed.")
