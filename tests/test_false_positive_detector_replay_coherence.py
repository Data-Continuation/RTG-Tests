#!/usr/bin/env python3
"""Provisional RTG false positive detector replay coherence tests."""
...
FIXTURE_PATH = ROOT / "fixtures" / "false-positive-detector-replay-coherence.valid.json"
...
def main() -> None:
    ...
    print("RTG false positive detector replay coherence tests passed.")
