...
LAYER_ID='rtg_formal_architecture_readiness_gate'
SURFACE='formal architecture readiness gate'
OUTPUT_KEY='readiness_gate_results'
REQUIRED_INPUTS=['proof_candidates', 'theorem_candidates', 'model_check_adapter', 'external_theorem_prover_adapter', 'formal_evidence_export', 'master_records_audit', 'traceability', 'axiom_revision_ledger', 'operator_closure', 'invariant_stress', 'minimal_basis']
