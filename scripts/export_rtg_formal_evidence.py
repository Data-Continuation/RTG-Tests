...
LAYER_ID='rtg_formal_evidence_export'
SURFACE='formal evidence export'
OUTPUT_KEY='formal_evidence_exports'
REQUIRED_INPUTS=['proof_candidates', 'theorem_candidates', 'model_check_adapter', 'external_theorem_prover_adapter']
